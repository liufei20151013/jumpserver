...
# CMDB
CMDB_ENABLED = CONFIG.CMDB_ENABLED
CMDB_FULL_DATA_SYNC_CRONTAB = CONFIG.CMDB_FULL_DATA_SYNC_CRONTAB
CMDB_INCREMENTAL_DATA_SYNC_CRONTAB = CONFIG.CMDB_FULL_DATA_SYNC_CRONTAB
CMDB_USERNAME = CONFIG.CMDB_USERNAME
CMDB_PASSWORD = CONFIG.CMDB_PASSWORD
CMDB_BK_PAAS_HOST = CONFIG.CMDB_BK_PAAS_HOST
CMDB_BK_APP_CODE = CONFIG.CMDB_BK_APP_CODE
CMDB_BK_APP_SECRET = CONFIG.CMDB_BK_APP_SECRET

# PAM
PAM_ENABLED = CONFIG.PAM_ENABLED
PAM_FULL_DATA_SYNC_CRONTAB = CONFIG.PAM_FULL_DATA_SYNC_CRONTAB
PAM_INCREMENTAL_DATA_SYNC_CRONTAB = CONFIG.PAM_INCREMENTAL_DATA_SYNC_CRONTAB
PAM_SERVER = CONFIG.PAM_SERVER
PAM_API_KEY = CONFIG.PAM_API_KEY

# DLT
DLT_ENABLED = CONFIG.DLT_ENABLED
DLT_FULL_DATA_SYNC_CRONTAB = CONFIG.DLT_FULL_DATA_SYNC_CRONTAB
DLT_INCREMENTAL_DATA_SYNC_CRONTAB = CONFIG.DLT_INCREMENTAL_DATA_SYNC_CRONTAB

# 组织管理员可授权角色ID
ENABLE_ORG_ROLE_IDS = CONFIG.ENABLE_ORG_ROLE_IDS
