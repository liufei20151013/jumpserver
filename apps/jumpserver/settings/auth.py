...
# Ris
RIS_ENABLED = CONFIG.RIS_ENABLED
RIS_AUTH_URL = CONFIG.RIS_AUTH_URL
RIS_APP_ID = CONFIG.RIS_APP_ID
RIS_ACCESS_KEY_ID = CONFIG.RIS_ACCESS_KEY_ID
RIS_ACCESS_KEY_SECRET = CONFIG.RIS_ACCESS_KEY_SECRET
# Ris 定时同步
RIS_SYNC_IS_PERIODIC = CONFIG.RIS_SYNC_IS_PERIODIC
RIS_SYNC_INTERVAL = CONFIG.RIS_SYNC_INTERVAL
RIS_SYNC_CRONTAB = CONFIG.RIS_SYNC_CRONTAB
