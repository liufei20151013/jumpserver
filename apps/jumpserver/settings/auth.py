...
ITSM_ENABLED = CONFIG.ITSM_ENABLED
ITSM_USER = CONFIG.ITSM_USER
ITSM_ORG = CONFIG.ITSM_ORG
ITSM_SERVER = CONFIG.ITSM_SERVER
ITSM_HOST = CONFIG.ITSM_HOST
ITSM_OBJECT_ID = CONFIG.ITSM_OBJECT_ID
ITSM_SYNC_CRONTAB = CONFIG.ITSM_SYNC_CRONTAB
ITSM_AREA = CONFIG.ITSM_AREA
ITSM_ENVIRONMENT = CONFIG.ITSM_ENVIRONMENT

ITSM_CHANGE_SECRET_ENABLED = CONFIG.ITSM_CHANGE_SECRET_ENABLED

ITSM_SYNC_JS_DATA_ENABLED = CONFIG.ITSM_SYNC_JS_DATA_ENABLED
ITSM_SYNC_JS_HOST = CONFIG.ITSM_SYNC_JS_HOST
ITSM_SYNC_JS_AK = CONFIG.ITSM_SYNC_JS_AK
ITSM_SYNC_JS_SK = CONFIG.ITSM_SYNC_JS_SK
ITSM_SYNC_JS_CRONTAB = CONFIG.ITSM_SYNC_JS_CRONTAB

ITSM_SYNC_JS_MFA_DATA_ENABLED = CONFIG.ITSM_SYNC_JS_MFA_DATA_ENABLED
ITSM_SYNC_JS_MFA_HOST = CONFIG.ITSM_SYNC_JS_MFA_HOST
ITSM_SYNC_JS_MFA_AK = CONFIG.ITSM_SYNC_JS_MFA_AK
ITSM_SYNC_JS_MFA_SK = CONFIG.ITSM_SYNC_JS_MFA_SK
