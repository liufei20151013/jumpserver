...
from .base import (
    ...
    REDIS_SENTINEL_SOCKET_TIMEOUT, EMAIL_QUEUE
)
...
# 邮件任务统一投递到 email 队列（仅主节点 worker 监听，由主节点集中发送 SMTP）
CELERY_TASK_ROUTES = {
    'common.tasks.send_mail_async': {'queue': EMAIL_QUEUE},
    'common.tasks.send_mail_attachment_async': {'queue': EMAIL_QUEUE},
}
